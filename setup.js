...
con.query("CREATE TABLE players(id BIGINT NOT NULL, userName VARCHAR(30) NOT NULL, elo INT, wins INT, losses INT, totalGames INT, PRIMARY KEY(id));", (error, response) => {
    if (error) throw error
    else
